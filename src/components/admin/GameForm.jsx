...
function GameForm({ game, onSave, onCancel }) {
  ...
  const [descriptionPreviewMode, setDescriptionPreviewMode] = useState(false) // 'edit' or 'preview' for full_description
      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          <label className="block text-sm font-medium text-gray-700">
            Full Description <span className="text-shusmo-yellow font-semibold">(Markdown)</span>
          </label>
        ...
        {descriptionPreviewMode ? (
          /* Preview Mode */
          <div className="min-h-[200px] p-4 border border-gray-300 rounded-shusmo bg-white prose prose-sm max-w-none overflow-y-auto
            ...
            prose-a:text-shusmo-yellow prose-a:no-underline hover:prose-a:underline
            prose-strong:text-shusmo-black
            prose-code:bg-gray-100 prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded prose-code:text-xs
            prose-blockquote:border-l-4 prose-blockquote:border-shusmo-yellow prose-blockquote:bg-gray-50 prose-blockquote:px-4 prose-blockquote:py-2 prose-blockquote:my-4
            prose-ul:my-3 prose-ul:list-disc prose-li:my-1.5
            prose-ol:my-3 prose-ol:list-decimal prose-li:my-1.5
          ">
...
## Overview
This is an **amazing** game with exciting features.
...
[Learn more](https://example.com)"
        ...
        <p className="mt-2 text-xs text-gray-500">
          Supports Markdown: # headings, **bold**, *italic*, - lists, {'>'} quotes, `code`, [links](url), ![images](url)
        </p>
      </div>
